...
Nova.booting((Vue, router, store) => {
    ...
    Vue.component('MultipleValueMetric', require('./components/MultipleValueMetric').default)
    ...
    Vue.component('BaseMultipleValueMetric', require('./components/Base/MultipleValueMetric').default)
